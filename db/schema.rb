...
ActiveRecord::Schema.define(version: 2020_04_18_180418) do
  ...
  create_table "orders", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["requests_id"], name: "index_orders_on_requests_id"
  ...
  add_foreign_key "orders", "requests", column: "requests_id"
